...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'mat.wast';
  var wasmBinaryFile = 'mat.wasm';
  var asmjsCodeFile = 'mat.temp.asm.js';
...
var real__test0 = asm["_test0"]; asm["_test0"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__test0.apply(null, arguments);
};

var real__test1 = asm["_test1"]; asm["_test1"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__test1.apply(null, arguments);
};
...
var _test0 = Module["_test0"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_test0"].apply(null, arguments) };
var _test1 = Module["_test1"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_test1"].apply(null, arguments) };
